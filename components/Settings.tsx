...
const THEMES: Theme[] = [
	...
	},
	{
		id: 'dracula',
		name: 'Dracula',
		colors: { primary: '#a855f7', background: '#27272a' },
	},
	{
		id: 'supabase',
		name: 'Supabase',
		colors: { primary: '#3ecf8e', background: '#1c1c1c' },
	},
	{
		id: 'cyberpunk',
		name: 'Cyberpunk',
		colors: { primary: '#14b8a6', background: '#1a0b2e' },
	},
	{
		id: 'matrix',
		name: 'Matrix',
		colors: { primary: '#22c55e', background: '#000000' },
	},
	{
		id: 'forest',
		name: 'Forest',
		colors: { primary: '#10b981', background: '#064e3b' },
	},
	{
		id: 'ocean',
		name: 'Ocean',
		colors: { primary: '#06b6d4', background: '#164e63' },
	},
	...
	// Warm/Earth Themes
	{
		id: 'sunset',
		name: 'Sunset (Laranja)',
		colors: { primary: '#f97316', background: '#44403c' },
	},
	{
		id: 'jungle',
		name: 'Jungle (Verde)',
		colors: { primary: '#84cc16', background: '#44403c' },
	},
	...
	// Light Themes
	{
		id: 'light',
		name: 'Clean (Azul)',
		colors: { primary: '#4f46e5', background: '#f3f4f6' },
	},
	{
		id: 'blossom',
		name: 'Blossom (Rosa)',
		colors: { primary: '#f43f5e', background: '#fff1f2' },
	},
	{
		id: 'sky',
		name: 'Sky (Céu)',
			...
			<div className="flex-1 p-8 max-w-4xl mx-auto w-full">
				...
				<section className="mb-12 animate-in fade-in slide-in-from-bottom-2 duration-300">
					<div className="mb-6">
						...
						<p className="text-sm text-base-muted mt-1">
							Gerencie vínculos com serviços externos.
						</p>
					</div>
								...
								<div
									className={`p-3 rounded-lg ${
										user?.githubToken
											...
											: 'bg-base-900 text-base-muted'
									}`}
								>
									<Github size={24} />
								</div>
								<div>
									<h3 className="font-medium text-base-text">
										GitHub
									</h3>
									{user?.githubLogin ? (
										<p className="text-sm text-green-400 mt-1 flex items-center gap-1">
											<Check size={12} /> Conectado como{' '}
											<strong>@{user.githubLogin}</strong>
										</p>
									) : (
										<p className="text-sm text-base-muted mt-1">
											Vincule sua conta para sincronizar
				...
				<section className="mb-12 animate-in fade-in slide-in-from-bottom-2 duration-300 delay-75">
					<div className="mb-6">
						...
						<p className="text-sm text-base-muted mt-1">
							Personalize a interface para se adequar ao seu
							estilo.
						</p>
					</div>
				...
				<section className="animate-in fade-in slide-in-from-bottom-2 duration-300 delay-100">
					<div className="mb-6">
						...
						<p className="text-sm text-base-muted mt-1">
							Informações sobre conexões externas.
						</p>
					</div>
					...
					<div className="bg-base-800 rounded-xl p-6 border border-base-700">
						<div className="flex items-start gap-4 mb-6">
							...
							<div>
								...
								<p className="text-sm text-base-muted mt-1">
									O banco de dados está configurado e ativo.
									Os dados são salvos na nuvem
									automaticamente.
								</p>
